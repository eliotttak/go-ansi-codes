...
// Package erase defines ANSI escape sequences that, for most of them, sets and/or modify the
// terminal mode (size, colored/monochrome, etc.)
//
// Some of theses sequences are no longer supported by modern terminal emulators, and should not be
// used.
//
